...
import 'package:lib_charts/order_book/orderbook_line_graph.dart';
...
class BooksAmountLinesScreen extends BaseChartScreen {
  const BooksAmountLinesScreen(
  ...
  static String get route => '/amount_lines';
