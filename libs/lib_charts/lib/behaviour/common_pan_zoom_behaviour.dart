...
class CommonPanAndZoomBehavior<D> extends CommonPanControlBehaviour<D> {
  ...
  bool onDragUpdate(Point<double> localPosition, double scale) {
    ...
    setViewportSettings(newScalingFactor, domainAxis.viewportTranslatePx,
        chart.drawAreaBounds.width);
  ...
  bool onDragEnd(
    ...
    final r = super.onDragEnd(localPosition, scale, pixelsPerSec);
    return r;
  }
